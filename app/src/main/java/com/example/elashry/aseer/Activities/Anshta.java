...
public class Anshta extends AppCompatActivity {
    ...
    private String TAG = Anshta.class.getSimpleName();
...
import com.example.elashry.aseer.Fragments.FirstFragment;
import com.example.elashry.aseer.Fragments.FourFragment;
import com.example.elashry.aseer.R;
import com.example.elashry.aseer.Fragments.SecodFragment;
import com.example.elashry.aseer.Fragments.ThirdFragment;
...
public class Anshta extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
                    ...
                    public boolean onNavigationItemSelected(@NonNull MenuItem item) {
                        ...
                        switch (item.getItemId()) {
                            ...
                            case R.id.action_item2:
                                selectedFragment = SecodFragment.newInstance();
                                break;
        ...
        FragmentTransaction transaction = getSupportFragmentManager().beginTransaction();
        FragmentTransaction replace = transaction.replace(R.id.frame_layout, FirstFragment.newInstance());
        transaction.commit();
       // fetchImages();
